    ...
    internal class Program
    {
        class MyArrayDeque<T>
        {
            ...
            public T peek()
            {
                ...
                else return elements[head];// или от 0
            }
            public T poll()
            {
                if (tail == 0) throw new Exception("null");
            ...
            public bool offerFirst(T obj) //н
            {
                addFirst(obj);
                if (contains(obj)) return true;
                return false;
            }
            public bool offerLast(T obj) //н
            {
                addLast(obj);
                if (contains(obj)) return true;
                return false;
            ...
            {
            //int[] mas1 = {1,2,3,1,1,4,5,6,7};
            //    MyArrayDeque<int> mas=new MyArrayDeque<int>(mas1);
           
            //for (int i = 0; i < mas.Size(); i++)
            //{
            //    Console.WriteLine(mas.get(i));
            //}
